...
const Hero = () => {
  ...
  // rounded-bl-[7vw]
  return (
    <div className=" md:min-h-[650px] md:h-[80vh] h-screen 
     overflow-hidden
     w-full
     flex
     justify-center items-center relative isolate">
      <video
        src="/hero_video.mp4"
        loop
        controls={false}
      ...
      <div className="w-full flex justify-center items-center bg-black bg-opacity-40 py-[40px]">
        <div className="w-[90%] flex justify-start items-center md:text-left text-center md:items-start flex-col gap-5">
          <h1 className="text-white font-black text-[30px] sm:text-[40px] md:text-[48px] leading-[1] max-w-[800px]">
            MVP Software Development<br/> for your startup
          </h1>
          <p className="text-white mt-2 text-base sm:text-lg md:text-xl font-regular leading-[1.2] max-w-[700px]">
